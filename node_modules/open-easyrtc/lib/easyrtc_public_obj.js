...
pub.app = function(appName, callback) {
    ...
    appObj.connection = function(easyrtcid, callback) {
        ...
        if (!pub.socketServer.sockets.sockets.get(socketId) || pub.socketServer.sockets.sockets.get(socketId).disconnected) {
        ...
        if (pub.socketServer.sockets.sockets.get(socketId).disconnected) {
        ...
        if (pub.socketServer.sockets.connected) {
            ...
            connectionObj.socket = pub.socketServer.sockets.sockets.get(socketId);
        }
